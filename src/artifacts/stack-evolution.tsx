...
const PERIODS = [
  ...
  { id: "h12025", label: "H1 2025", sub: "DeepSeek R1, Claude 4" },
  { id: "h22025", label: "H2 2025", sub: "GPT-5, Claude 4.5" },
...
const ROWS = [
  // Architecture
  {
    ...
    cells: [
      ...
      { s: 1, n: "DeepSeek V3 (Dec 2024), R1 (Jan 2025): still transformer. Pure transformer wins." },
  ...
  },
  {
    ...
    cells: [
      ...
      { s: 2, n: "Both coexist. Claude 3 likely dense; GPT-4o refines MoE. DeepSeek V2 (May): 160 experts." },
      { s: 2, n: "Llama 3.1 stays dense. DeepSeek V2 MoE validated at scale." },
  ...
  },
  {
    ...
    cells: [
      ...
      { s: 2, n: "GQA default. DeepSeek V2 introduces MLA (multi-latent attention, May 2024). Flash Attention v2." },
      { s: 2, n: "MLA validated. Minor iteration on GQA ratios." },
      { s: 3, n: "DeepSeek V3 MLA at scale. Sparse/sliding window attention explored." },
  ...
  // Multimodal
  {
    ...
    cells: [
      ...
      { s: 0, n: "GPT-4 announced as multimodal but vision not yet available to users." },
      { s: 4, n: "GPT-4V launches (Sept 2023). LLaVA open-sources ViT → MLP → LLM recipe." },
  ...
  },
  {
    ...
    cells: [
      ...
      { s: 0, n: "DALL-E 2 still current. No LLM integration." },
      { s: 2, n: "DALL-E 3 launches (Oct 2023) via tool use. LLM writes prompt, separate model generates." },
  ...
  // Serving & Infra
  {
    ...
    cells: [
      ...
      { s: 3, n: "100K (Claude 2), then 200K (Claude 2.1). YaRN, NTK-scaling for RoPE extension." },
  ...
  },
  {
    ...
    cells: [
      { s: 0, n: "No tool use capability. ChatGPT is text-in, text-out." },
      { s: 3, n: "ChatGPT plugins (March), then GPT-4 function calling (June). Foundational." },
